...
/**
 * Test task without semantic annotations
 */
class PlainStringProviderTask extends Task<{ input: string }, { output: string }> {
...
/**
 * Test task that accepts plain string input without semantic annotations
 */
class PlainStringConsumerTask extends Task<{ input: string }, { result: string }> {
